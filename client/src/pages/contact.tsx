      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-3 gap-6 mb-4">
            <div className="bg-white rounded-xl p-6 text-center border border-gray-200/70 shadow-sm">
            ...
            <div className="bg-white rounded-xl p-6 text-center border border-gray-200/70 shadow-sm">
              <Linkedin className="w-8 h-8 text-accent mx-auto mb-3" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ul className="space-y-3 text-gray-700">
            <li>
              ...
              <Link href="/resources/how-to-apply" className="text-accent hover:underline">
                application guide
              </Link>{" "}
              or{" "}
            ...
            <li>
              ...
              <Link href="/resources/ucl-edtech-labs-faq" className="text-accent hover:underline">
