    ...
    <section id="apply" className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Join Our Next Cohort</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Apply to our current programs or register your interest for upcoming cohorts. We're looking for passionate founders ready to transform education.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-slate-50 rounded-2xl p-8">
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Active Application</h3>
              <p className="text-gray-600">Apply now for our current programs with immediate entry available.</p>
              <div className="flex items-center mt-4">
                <span className="w-3 h-3 bg-success rounded-full mr-2"></span>
                <Badge className="bg-success text-white">Applications Open</Badge>
              </div>
            </div>
            ...
            <Form {...applicationForm}>
              <form onSubmit={applicationForm.handleSubmit(onApplicationSubmit)} className="space-y-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          <SelectItem value="london">London Program - March 2024</SelectItem>
                          <SelectItem value="toronto">Toronto Program - April 2024</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          rows={4} 
                          placeholder="Describe your EdTech solution and its impact..." 
                          {...field} 
                        />
                      </FormControl>
                      <FormMessage />
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-primary text-white py-4 font-bold text-lg hover:bg-blue-700"
                ...
                <p className="text-sm text-gray-500 text-center">
                  Application deadline: <span className="font-medium">February 15, 2024</span>
                </p>
              </form>
            </Form>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl p-8">
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Register Interest</h3>
              ...
              <div className="flex items-center mt-4">
                ...
                <Badge className="bg-accent text-gray-900">Opening Soon</Badge>
              </div>
            </div>
